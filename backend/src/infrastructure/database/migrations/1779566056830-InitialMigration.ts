...
export class InitialMigration1779566056830 implements MigrationInterface {
    name = 'InitialMigration1779566056830'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."job_offers_work_mode_enum" AS ENUM('hybrid', 'remote', 'office')`);
        ...
        await queryRunner.query(`ALTER TABLE "user_files" ADD CONSTRAINT "FK_291b9ce1850149b4a69bca53af1" FOREIGN KEY ("candidate_id") REFERENCES "candidates"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_files" DROP CONSTRAINT "FK_291b9ce1850149b4a69bca53af1"`);
